...
// the Firm Cockpit. Behavior of this page is otherwise unchanged.
//
// (See historical commentary on this page's evolution from v20 → v21g-2 in
// the original app/page.tsx commit history.)
